...
const DesignThinkingEpicLeftSidebar = ({benchmarkingProject, decompositionProject, kpisControl,addDrag, toggleClass,closePanel}) => {
  ...
  let projects = benchmarkingProject.map((project)=>{
    ...
    return(<div key={project.id} className="card">
        <div className="d-flex">
          ...
          <a data-toggle="collapse" href={"#benchmarking"+project.id} className="test">{project.name}</a>
        </div>
...
let decomposeProjects = decompositionProject.map((compose)=>{
  let functions = compose.functions.map((func)=>{
    let phases = func.phases.map((phase)=>{
      ...
      return(<li key={phase.id} >
        <div className="card">
            ...
            <a data-toggle="collapse" href={"#decompose"+phase.id}>{phase.name}</a>
            </div>
      ...
      return(<li key={func.id}>
        <div className="card">
          <div className="d-flex">
            ...
            <a data-toggle="collapse" href={"#decompose"+func.id}>{func.name}</a> 
          </div>
  ...
  return(<div key={compose.id} className="card">
    <div className="d-flex">
      ...
      <a data-toggle="collapse" href={"#decompose"+compose.id}>{compose.name}</a>
      </div>
...
let kpis = kpisControl.map((kp)=>{
    ...
    return(<li key={kpi.id}>
      <div className="card">
        <div className="d-flex">
          ...
          <a data-toggle="collapse" href={"#kpis"+kpi.id}>{kpi.name}</a>
        </div>
  ...
  return(<div key={kp.id} className="card">
        <div className="d-flex">
          <div className="custom-checkbox">
          ...
          <a data-toggle="collapse" href={"#kpis"+kp.id}>{kp.name}</a>
        </div>
