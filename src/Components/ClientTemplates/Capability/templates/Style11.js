...
class Style11 extends Component {
    constructor(props) {
        super(props);
        this.state = {
    ...
    handleTitleChange(e,index){
        ...
        this.props.handleTitleChange(e, 'style11', index, this.props.functionId, this.props.phaseId);
    }
