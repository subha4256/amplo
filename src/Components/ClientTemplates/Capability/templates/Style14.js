                ...
                <div className="d-flex pstyle14">
                    ...
                    <div>
                        <div className="vrt-box d-flex">
                            ...
                            <div className={class9}><span className="vtext vtext-temp3 spanforlink" title={this.state.processTitle9} style={{display: this.state['showLabel9'] === false ? 'none' : 'block'}}>{this.props.processData[9] ? <Link to={"/client-capability-modeling/"+this.props.templateId+"/"+this.props.processData[9].processId+"/"+this.props.functionId+"/"+this.props.phaseId} title={this.props.processData[9].processTitle}>{this.props.processData[9].processTitle}</Link> : this.state.processTitle9}</span> <span className="fa fa-edit float-left fl-sl3" onClick={this.handleEditProcess.bind(this, 9)} style={{display: this.state['showLabel9'] === false ? 'none' : 'block'}}></span><span className="fa fa-times text-danger float-right" onClick={this.props.handleDeleteProcess.bind(this, this.props.processData[9])} style={{display: this.state['showLabel9'] === false ? 'none' : 'block'}}></span><input type="text" className="rotate-textbox-Style14" style={{display: this.state['showLabel9'] === false ? 'block' : 'none'}} onBlur={() => this.handleTitleBlur(9, this.props.processData[9].processId)} onChange={(e) => this.handleTitleChange(e,9)} value={this.props.processData[9] ? this.props.processData[9].processTitle : 'Add Process'} /></div>
                        </div>
                    </div>
                </div>
            </div>
