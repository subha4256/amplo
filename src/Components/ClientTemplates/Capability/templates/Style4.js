...
class Style4 extends Component {
    ...
    handleTitleChange(e,index){
        ...
        this.props.handleTitleChange(e, 'style4', index, this.props.functionId, this.props.phaseId);
    }
    ...
    render() {
        let class0 = "box box-white sm-txt w-100 h-31-four";
        if(this.props.processData[0]) {
            if(this.props.processData[0].HasDecomposition === "1") {
                class0 = "box bg-average sm-txt w-100 h-31-four";
            }
        }
        let class1 = "box box-white sm-txt w-100 h-31-four";
        if(this.props.processData[1]) {
            if(this.props.processData[1].HasDecomposition === "1") {
                class1 = "box bg-average sm-txt w-100 h-31-four";
            }
        }
        let class2 = "box box-white sm-txt w-100 h-31-four";
        if(this.props.processData[2]) {
            if(this.props.processData[2].HasDecomposition === "1") {
                class2 = "box bg-average sm-txt w-100 h-31-four";
            }
        }
        let class3 = "box box-white sm-txt w-100 h-31-four";
        if(this.props.processData[3]) {
            if(this.props.processData[3].HasDecomposition === "1") {
                class3 = "box bg-average sm-txt w-100 h-31-four";
            }
        }
        let class4 = "box box-white sm-txt w-100 h-31-four";
        if(this.props.processData[4]) {
            if(this.props.processData[4].HasDecomposition === "1") {
                class4 = "box bg-average sm-txt w-100 h-31-four";
            }
        }
        let class5 = "box box-white sm-txt w-100 h-31-four";
        if(this.props.processData[5]) {
            if(this.props.processData[5].HasDecomposition === "1") {
                class5 = "box bg-average sm-txt w-100 h-31-four";
            }
        }
        return(
