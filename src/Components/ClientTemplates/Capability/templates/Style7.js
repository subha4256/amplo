...
class Style7 extends Component {
    ...
    handleTitleChange(e,index){
        ...
        this.props.handleTitleChange(e, 'style7', index, this.props.functionId, this.props.phaseId);
    }
    ...
    render() {
        let class0 = "box box-white sm-txt w-100 h-30 h-30seven pstyle7";
        if(this.props.processData[0]) {
            if(this.props.processData[0].HasDecomposition === "1") {
                class0 = "box bg-average sm-txt w-100 h-30 h-30seven pstyle7";
            }
        }
        let class1 = "box box-white sm-txt w-100 w-110px-seven h-30seven h-30 pstyle7";
        if(this.props.processData[1]) {
            if(this.props.processData[1].HasDecomposition === "1") {
                class1 = "box bg-average sm-txt w-100 w-110px-seven h-30seven h-30 pstyle7";
            }
        }
        let class2 = "box box-white sm-txt w-100 w-110px-seven h-37seven h-42 pstyle7";
        if(this.props.processData[2]) {
            if(this.props.processData[2].HasDecomposition === "1") {
                class2 = "box bg-average sm-txt w-100 w-110px-seven h-37seven h-42 pstyle7";
            }
        }
        let class3 = "box box-white sm-txt w-100 w-110px-seven h-30seven h-30 pstyle7";
        if(this.props.processData[3]) {
            if(this.props.processData[3].HasDecomposition === "1") {
                class3 = "box bg-average sm-txt w-100 w-110px-seven h-30seven h-30 pstyle7";
            }
        }
        let class4 = "box box-white vtext7div sm-txt mr-2";
        if(this.props.processData[4]) {
            if(this.props.processData[4].HasDecomposition === "1") {
                class4 = "box bg-average vtext7div sm-txt mr-2";
            }
        }
        let class5 = "box box-white vtext7div sm-txt";
        if(this.props.processData[5]) {
            if(this.props.processData[5].HasDecomposition === "1") {
                class5 = "box bg-average vtext7div sm-txt";
            }
        }
        let class6 = "box box-white sm-txt w-100 h-30seven h-30 pstyle7";
        if(this.props.processData[6]) {
            if(this.props.processData[6].HasDecomposition === "1") {
                class6 = "box bg-average sm-txt w-100 h-30seven h-30 pstyle7";
            }
        }
        let class7 = "box box-white sm-txt w-100 h-30seven h-30 pstyle7";
        if(this.props.processData[7]) {
            if(this.props.processData[7].HasDecomposition === "1") {
                class7 = "box bg-average sm-txt w-100 h-30seven h-30 pstyle7";
            }
        }
        return(
            <div className="style7">
                <div className={class0}><span className="spanforlink" title={this.state.processTitle0}  style={{display: this.state['showLabel0'] === false ? 'none' : 'block'}}>{this.props.processData[0] ? <Link to={"/client-capability-modeling/"+this.props.templateId+"/"+this.props.processData[0].processId+"/"+this.props.functionId+"/"+this.props.phaseId} title={this.props.processData[0].processTitle}>{this.props.processData[0].processTitle}</Link> : this.state.processTitle0}</span> <span className="fa fa-edit float-left" onClick={this.handleEditProcess.bind(this, 0)} style={{display: this.state['showLabel0'] === false ? 'none' : 'block'}}></span><span className="fa fa-times text-danger float-right" onClick={this.props.handleDeleteProcess.bind(this, this.props.processData[0])} style={{display: this.state['showLabel0'] === false ? 'none' : 'block'}}></span><input type="text" style={{display: this.state['showLabel0'] === false ? 'block' : 'none',width:"100%"}} onBlur={() => this.handleTitleBlur(0, this.props.processData[0].processId)} onChange={(e) => this.handleTitleChange(e,0)} value={this.props.processData[0] ? this.props.processData[0].processTitle : 'Add Process'} /></div>
                <div className="d-flex">
                    <div className="mr-2">
                        <div className={class1}><span className="spanforlink" title={this.state.processTitle1}  style={{display: this.state['showLabel1'] === false ? 'none' : 'block'}}>{this.props.processData[1] ? <Link to={"/client-capability-modeling/"+this.props.templateId+"/"+this.props.processData[1].processId+"/"+this.props.functionId+"/"+this.props.phaseId} title={this.props.processData[1].processTitle}>{this.props.processData[1].processTitle}</Link> : this.state.processTitle1}</span> <span className="fa fa-edit float-left" onClick={this.handleEditProcess.bind(this, 1)} style={{display: this.state['showLabel1'] === false ? 'none' : 'block'}}></span><span className="fa fa-times text-danger float-right" onClick={this.props.handleDeleteProcess.bind(this, this.props.processData[1])} style={{display: this.state['showLabel1'] === false ? 'none' : 'block'}}></span><input type="text" style={{display: this.state['showLabel1'] === false ? 'block' : 'none',width:"100%"}} onBlur={() => this.handleTitleBlur(1, this.props.processData[1].processId)} onChange={(e) => this.handleTitleChange(e,1)} value={this.props.processData[1] ? this.props.processData[1].processTitle : 'Add Process'} /></div>
                    ...
                    <div className="vrt-box d-flex">
                        <div className={class4}><span className="vtext vtext7text spanforlink" title={this.state.processTitle4} style={{display: this.state['showLabel4'] === false ? 'none' : 'block'}}>{this.props.processData[4] ? <Link className="lineclamp2" to={"/client-capability-modeling/"+this.props.templateId+"/"+this.props.processData[4].processId+"/"+this.props.functionId+"/"+this.props.phaseId} title={this.props.processData[4].processTitle}>{this.props.processData[4].processTitle}</Link> : this.state.processTitle4}</span> <span className="fa fa-edit float-left fl-sl3" onClick={this.handleEditProcess.bind(this, 4)} style={{display: this.state['showLabel4'] === false ? 'none' : 'block'}}></span><span className="fa fa-times text-danger float-right" onClick={this.props.handleDeleteProcess.bind(this, this.props.processData[4])} style={{display: this.state['showLabel4'] === false ? 'none' : 'block'}}></span><input type="text" className="rotate-textbox7" style={{display: this.state['showLabel4'] === false ? 'block' : 'none'}} onBlur={() => this.handleTitleBlur(4, this.props.processData[4].processId)} onChange={(e) => this.handleTitleChange(e,4)} value={this.props.processData[4] ? this.props.processData[4].processTitle : 'Add Process'} /></div>
                        <div className={class5}><span className="vtext vtext7text spanforlink" title={this.state.processTitle5} style={{display: this.state['showLabel5'] === false ? 'none' : 'block'}}>{this.props.processData[5] ? <Link className="lineclamp2" to={"/client-capability-modeling/"+this.props.templateId+"/"+this.props.processData[5].processId+"/"+this.props.functionId+"/"+this.props.phaseId} title={this.props.processData[5].processTitle}>{this.props.processData[5].processTitle}</Link> : this.state.processTitle5}</span> <span className="fa fa-edit float-left fl-sl3" onClick={this.handleEditProcess.bind(this, 5)} style={{display: this.state['showLabel5'] === false ? 'none' : 'block'}}></span><span className="fa fa-times text-danger float-right" onClick={this.props.handleDeleteProcess.bind(this, this.props.processData[5])} style={{display: this.state['showLabel5'] === false ? 'none' : 'block'}}></span><input type="text" className="rotate-textbox7" style={{display: this.state['showLabel5'] === false ? 'block' : 'none'}} onBlur={() => this.handleTitleBlur(5, this.props.processData[5].processId)} onChange={(e) => this.handleTitleChange(e,5)} value={this.props.processData[5] ? this.props.processData[5].processTitle : 'Add Process'} /></div>
                    </div>
                    </div>
                </div>
                <div className={class6}><span className="spanforlink" title={this.state.processTitle6}  style={{display: this.state['showLabel6'] === false ? 'none' : 'block'}}>{this.props.processData[6] ? <Link to={"/client-capability-modeling/"+this.props.templateId+"/"+this.props.processData[6].processId+"/"+this.props.functionId+"/"+this.props.phaseId} title={this.props.processData[6].processTitle}>{this.props.processData[6].processTitle}</Link> : this.state.processTitle6}</span> <span className="fa fa-edit float-left" onClick={this.handleEditProcess.bind(this, 6)} style={{display: this.state['showLabel6'] === false ? 'none' : 'block'}}></span><span className="fa fa-times text-danger float-right" onClick={this.props.handleDeleteProcess.bind(this, this.props.processData[6])} style={{display: this.state['showLabel6'] === false ? 'none' : 'block'}}></span><input type="text" style={{display: this.state['showLabel6'] === false ? 'block' : 'none',width:"100%"}} onBlur={() => this.handleTitleBlur(6, this.props.processData[6].processId)} onChange={(e) => this.handleTitleChange(e,6)} value={this.props.processData[6] ? this.props.processData[6].processTitle : 'Add Process'} /></div>
                <div className={class7}><span className="spanforlink" title={this.state.processTitle7}  style={{display: this.state['showLabel7'] === false ? 'none' : 'block'}}>{this.props.processData[7] ? <Link to={"/client-capability-modeling/"+this.props.templateId+"/"+this.props.processData[7].processId+"/"+this.props.functionId+"/"+this.props.phaseId} title={this.props.processData[7].processTitle}>{this.props.processData[7].processTitle}</Link> : this.state.processTitle7}</span> <span className="fa fa-edit float-left" onClick={this.handleEditProcess.bind(this, 7)} style={{display: this.state['showLabel7'] === false ? 'none' : 'block'}}></span><span className="fa fa-times text-danger float-right" onClick={this.props.handleDeleteProcess.bind(this, this.props.processData[7])} style={{display: this.state['showLabel7'] === false ? 'none' : 'block'}}></span><input type="text" style={{display: this.state['showLabel7'] === false ? 'block' : 'none',width:"100%"}} onBlur={() => this.handleTitleBlur(7, this.props.processData[7].processId)} onChange={(e) => this.handleTitleChange(e,7)} value={this.props.processData[7] ? this.props.processData[7].processTitle : 'Add Process'} /></div>
            </div>
        )
    }
}
