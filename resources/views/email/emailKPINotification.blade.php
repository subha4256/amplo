                ...
                <tr>
                  <td style="width:100%;">
                    ...
                    <p style="font-size:13px;margin-top:0px; line-height:20px; color:#212529;">
                       <br>This is the notification email for the KPI audit.
                    </p>
                    <!-- <p style="font-size:13px;margin-top:0px; line-height:20px; color:#212529;">
                      <a href="{{ $data['url'] }}" target="_blank" rel="noopener noreferrer">{{ $data['url'] }}</a>
                    </p> -->
                    <p><a href="{{ $data['url'] }}" style="padding: 12px 0px;
                        font-size: 13px;
                        ...
                        text-align: center;
                        width: 100%;
                        font-weight: 700; margin-bottom: 40px;">Go To The Page</a></p>
                    ...
                    <p style="font-size:13px;margin-top:0px;letter-spacing: -.5px; line-height:20px; color:#212529;">
                      <a href="{{ $data['url'] }}"
                        style="color: #083ac8;">{{ $data['url'] }}</a><br><br>
