          ...
          <div
            ...
            <div style="margin:0;  padding:0 90px; display:block;background:#f9fafb;border:0px #f1f1f1 solid;">
              <table style="padding:10px 0 0 0px; font-size:15px; width:100%;">
                <tr>
                  <td style="width:100%;">
                    <p style="font-size: 37.5px; font-weight: 700;color: #212529;margin-bottom: 22px;"></p>
                    ...
                    <p style="font-size:13px;margin-top:0px; line-height:20px; color:#212529;">
                      Your Amplo Global Inc Employee {{ $employee_first_name.' '.$employee_last_name }} with email Address {{ $employee_email }} and Employee ID {{ $employee_id }} has registered to access DIVA Portal with a {{ $employee_type }} grant. 

                     Kindly Approve the Request if found valid using below Access Link.   
                    </p>
                    ...
                    <p><a href="{{ $link }}" style="padding: 12px 0px;
                        ...
                        text-align: center;
                        width: 100%;
                        font-weight: 700; margin-bottom: 40px;">Approve</a></p>
