...
<head>
  <meta charset="utf-8">
  <title>Email Access Account</title>
  <meta name="viewport"
          ...
          <div
            ...
            <div style="margin:0;  padding:0 90px; display:block;background:#f9fafb;border:0px #f1f1f1 solid;">
              <table style="padding:10px 0 0 0px; font-size:15px; width:100%;">
                <tr>
                  <td style="width:100%;">
                    <p style="font-size: 37.5px; font-weight: 700;color: #212529;margin-bottom: 22px;">Congratulations
                    </p>
                    ...
                    <p style="font-size:13px;margin-top:0px; line-height:20px; color:#212529;">
                      Congratulations! You have successfully created your Amplo account. Click the link below to login
                      to your account.
                    </p>
                    ...
                    <p><a href="{{ $link }}" style="padding: 12px 0px;
                        ...
                        text-align: center;
                        width: 100%;
                        font-weight: 700; margin-bottom: 40px;">ACCESS ACCOUNT</a></p>
